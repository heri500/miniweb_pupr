...
blogy_templates theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of blogy_templates theme and run the following commands:
`nvm use`
...
`drush en blogy_templates -y`
`drush config-set system.theme default blogy_templates -y`
